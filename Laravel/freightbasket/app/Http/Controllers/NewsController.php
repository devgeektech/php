...
class NewsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('voyager::news.index', compact('newslist'));
    }
    ...
    public function create()
    {
        ...
        return view('voyager::news.create', compact('categories'));
    }
    ...
    public function edit(News $news)
    {
        ...
        return view('voyager::news.edit', compact('categories','news'));
    }
