...
<div class="container">
    @if (Auth::guest())
    <div class="nav-innertop">
	<div class="row">
	
	<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
		<div class="area-btn">
		    <div class="login-botton-area">
			  <a href="{{ url('/login') }}"><i class="fa fa-sign-in" aria-hidden="true"></i> Login In</a>
			</div>
		   <div class="register-botton-area">
			  <a href="{{ url('/register') }}"><i class="fa fa-user" aria-hidden="true"></i> Register</a>
			</div>
		</div>
		</div>
...
<div class="nav-inner">
  <a class="navbar-brand" href="{{ ('/')}}"><img class="img-fluid" src="{{ asset('images/logo.png') }}"></a>
    ...
    <ul class="navbar-nav ml-auto nev-clr">
      ...
      @if (Auth::guest())
          ...
          <ul class="dropdown-menu" role="menu">
             <li class="nav-item"><a class="nav-link " href="{{ route('Udashboard') }}" style="color:#000 !important;"><i class="fa fa-tachometer"></i> Dashboard</a></li>
       ...
       <div class="col-md-12 col-sm-12">
        ...
        <div class="row">
           <div class="col-md-3 col-sm-12">
                    ...
                    <a href="{{url('/')}}"><img src="{{ asset('images/footer-logo.png') }}"></a>
