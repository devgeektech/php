...
class ResponseController extends Controller
{
    ...
    public function respondNotFound($message = 'Not Found!')
    {
        return $this->respond([
            ...
            'message' => $message,
        ], ['status_code' => Res::HTTP_NOT_FOUND, 'message' => 'Invalid']);
    }
    ...
    public function respondValidationError($message, $errors)
    {
        return $this->respond([
            ...
            'message' => $message,
            'data' => $errors,
        ], ['status_code' => Res::HTTP_UNPROCESSABLE_ENTITY, 'message' => 'Invalid']);
    }

    public function respond($data, $headers = [])
    {
        if (isset($headers['status_code'])) {
            return Response::json($data, $headers['status_code']);
        } else {
    ...
    public function respondWithError($message)
    {
        return $this->respond([
            ...
            'message' => $message,
        ], ['status_code' => Res::HTTP_UNAUTHORIZED, 'message' => 'Invalid']);
    }
}
