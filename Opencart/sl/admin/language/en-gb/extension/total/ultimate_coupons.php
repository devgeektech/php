...
// Coupon Settings
$_['heading_coupon_settings']			= 'Coupon Settings';
$_['entry_cart_page_box']				= 'Cart Page Coupon Box: <div class="help-text">If you have disabled the "Coupon" Order Total, which normally hides the cart page coupon box, you can enable this setting to still show the coupon box on the cart page.</div>';
$_['entry_coupon_box']					= 'Checkout Coupon Box: <div class="help-text">If enabled, a coupon box will be displayed after the address steps of checkout, so customers can enter a coupon during checkout.</div>';
$_['entry_delete_used']					= 'Automatically Delete Used Coupons: <div class="help-text">If enabled, coupons from Ultimate Coupons will be automatically deleted when they have been used as many times as their "Uses Per Coupon" setting. <b>Note: there is no way to get these coupons back once deleted, so use with caution.</b></div>';
$_['entry_unset_shipping']				= 'Unset Shipping Applied to Order: <div class="help-text">If you have coupons that affect shipping, or shipping rates based on total, you can turn this on to unset the shipping choice on the order when applying a coupon. The customer would then need to re-choose a shipping method after applying a coupon.</div>';
...
$_['text_ignore_specials']				= 'Ignore Specials';
$_['text_products_with_special_prices']	= '= products with Special or Discount prices will be ignored';
...
$_['entry_sort_order']					= 'Sort Order: <div class="help-text">The sort order for the extension, relative to other Order Total extensions.</div>';

$_['tab_coupons']						= 'Coupons';
$_['help_coupons']						= 'By default, coupons are always available if the correct code is entered. Use "Rules" to restrict a coupon by specific criteria such as date, customer group, or product.';
$_['heading_coupons']					= 'Coupons';

$_['button_add_charge']					= 'Add Coupon';

$_['column_coupon']						= 'Coupon';
$_['text_code']							= 'Code:';
$_['text_uses_per_coupon']				= 'Uses Per Coupon:';
$_['text_uses_per_customer']			= 'Uses Per Customer:';
$_['text_status']						= 'Status:';

$_['help_charge_coupon']				= 'Enter the code for the coupon. Codes are NOT compared case-sensitively when being redeemed. Regular Expressions (regex) are supported.';
$_['help_charge_uses_per_coupon']		= 'Enter the maximum number of times the coupon can be used. Leave blank to have no limit on coupon uses.';
$_['help_charge_uses_per_customer']		= 'Enter the maximum number of times a single customer can use this coupon. Leave blank to have no limit on customer uses.<br /><br />Note that filling this in will result in making the coupon invalid for guests, since there is no way to track uses for guests.';
$_['help_charge_status']				= 'Choose whether the coupon is able to be used by customers.';
...
$_['help_charge_charges']				= 'For "Simple Charges", enter the flat charge or per item charge as a negative value (such as -5.00) or a percentage (such as -10%).<hr />For "Bracket Charges", separate brackets by commas or new lines, and enter them in the format:<br /><br /><b>From - To = Cost / Per</b><br /><br />The "Per" value is optional. If you leave out the "From" value, it will default to the previous bracket&#39;s "To" value (or 0 for the first bracket).<br /><br />For example, to give $2.00 off for 1 to 3 items, and $1.00 off per item for 4 or more items, you would choose "Quantity" and enter:<br /><div class="text-left" style="margin: 10px">1-3 = -2.00<br />4-9999 = -1.00 / 1</div>';

// Coupon Report
$_['tab_coupon_report']					= 'Coupon Report';
$_['heading_coupon_report']				= 'Coupon Report';
