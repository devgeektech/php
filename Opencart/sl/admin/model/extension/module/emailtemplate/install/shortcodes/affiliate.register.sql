...
('text_service', 'auto', 'Upon logging in, you will be able to generate tracking codes, track commission payments and edit your account information.', {_ID}),
('approval', 'auto', '1', {_ID}),
('login', 'auto', 'https://oc.local/index.php?route=affiliate/login', {_ID}),
('store', 'auto', 'Your Store', {_ID}),
...
('affiliate_text', 'auto', 'Your account must be approved before you can login. Once approved you can log in by using your e-mail address and password by visiting our website or at the following URL:', {_ID}),
