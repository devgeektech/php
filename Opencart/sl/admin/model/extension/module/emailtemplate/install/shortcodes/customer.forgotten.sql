...
('text_ip', 'language', 'The IP used to make this request was:', {_ID}),
...
('unsubscribe_url', 'auto', 'https://oc.local/index.php?route=extension/module/emailtemplate_newsletter/unsubscribe&token=4LsQAtge1o8epsJ67vwBpi9LuTQKZgCP', {_ID}),
('preference_url', 'auto', 'https://oc.local/index.php?route=extension/module/emailtemplate_newsletter&token=4LsQAtge1o8epsJ67vwBpi9LuTQKZgCP', {_ID}),
('password_link_text', 'auto', 'https://oc.local/index.php?route=account/reset&amp;email=opencart.templates%40gmail.com&amp;code=jip5IGDVA0VlNXDAF5Ncpd1UNxAeh4acbDklzKW5', {_ID}),
('password_link', 'auto', 'https://oc.local/index.php?route=account/reset&amp;email=opencart.templates%40gmail.com&amp;code=jip5IGDVA0VlNXDAF5Ncpd1UNxAeh4acbDklzKW5', {_ID}),
('customer_date_added', 'auto', '2019-03-01 13:51:16', {_ID}),
('customer_code', 'auto', 'jip5IGDVA0VlNXDAF5Ncpd1UNxAeh4acbDklzKW5', {_ID}),
('customer_safe', 'auto', '0', {_ID}),
('customer_status', 'auto', '1', {_ID}),
('customer_ip', 'auto', '::1', {_ID}),
('customer_custom_field', 'auto', '{\"1\":\"123\"}', {_ID}),
('customer_address_id', 'auto', '15', {_ID}),
('customer_newsletter', 'auto', '1', {_ID}),
('customer_salt', 'auto', 'n8DZ7as5B', {_ID}),
...
('reset', 'auto', 'https://oc.local/index.php?route=account/reset&code=jip5IGDVA0VlNXDAF5Ncpd1UNxAeh4acbDklzKW5', {_ID}),
