...
('mail.subject', 'auto', 'Alert - Customer reached max login attempts', {_ID}),
('mail.reply_to_name', 'auto', 'John', {_ID}),
...
('config_login_attempts', 'auto', '5', {_ID}),
('login_info_locale', 'auto', 'en_GB', {_ID}),
...
('login_info_browser', 'auto', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/72.0.3626.119 Safari/537.36', {_ID}),
('customer_date_added', 'auto', '2019-03-01 13:51:16', {_ID}),
('customer_safe', 'auto', '0', {_ID}),
('customer_ip', 'auto', '::1', {_ID}),
('customer_status', 'auto', 'text_enabled', {_ID}),
...
('login_attempt_date_added', 'auto', '2019-03-01 12:57:46', {_ID}),
('login_attempt_date_modified', 'auto', '2019-03-01 12:57:51', {_ID}),
('login_attempt_login_info_added', 'auto', '01/03/2019 12:57:46', {_ID}),
('login_attempt_total', 'auto', '5', {_ID}),
('login_attempt_ip', 'auto', '::1', {_ID}),
('login_attempt_email', 'auto', 'user@@oc.local', {_ID}),
('login_attempt_customer_login_id', 'auto', '6', {_ID}),
