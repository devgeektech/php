...
('mail.subject', 'auto', 'Welcome to Your Store', {_ID}),
...
('customer_text', 'auto', 'Your account must be approved before you can login. Once approved you can log in by using your email address and password by visiting our website or at the following URL:', {_ID}),
