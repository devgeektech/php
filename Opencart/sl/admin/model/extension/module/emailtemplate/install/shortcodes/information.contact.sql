...
('enquiry', 'auto', 'Test message\r<br />With line breaks.', {_ID}),
...
('mail.sender', 'auto', 'John', {_ID}),
('mail.reply_to', 'auto', 'user@@oc.local', {_ID}),
('mail.reply_to_name', 'auto', 'John', {_ID}),
('mail.subject', 'auto', 'Enquiry from: John at: Your Store', {_ID}),
...
('text_customer', 'language', 'Customer:', {_ID}),
('text_customer_subject', 'language', 'Copy of {{ store_name }} Enquiry', {_ID}),
('text_customer_heading', 'language', 'Thank you for your message!', {_ID}),
('text_customer_enquiry', 'language', 'Thank you for your enquiry, here is a Copy of message:', {_ID});