...
`emailtemplate_key` = 'admin.customer_deny',
`emailtemplate_label` = 'Customer Deny',
...
`emailtemplate_language_files` = 'mail/customer_deny,extension/module/emailtemplate/customer',
