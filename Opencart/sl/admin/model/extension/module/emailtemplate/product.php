...
class ModelExtensionModuleEmailTemplateProduct extends Model {
	...
	public function getProduct($product_id, $language_id = -1, $store_id = 0, $customer_group_id = -1) {
	...
	public function getProductRelated($product_id, $language_id, $store_id, $customer_group_id, $customer_id = 0) {
		...
		foreach ($query->rows as $result) {
			$product_data[$result['related_id']] = $this->getProduct($result['related_id'], $language_id, $store_id, $customer_group_id, $customer_id);
		}
