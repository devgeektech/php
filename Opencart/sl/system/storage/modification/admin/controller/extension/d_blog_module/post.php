...
// $url = $this->getUrl();
        ...
        $data['delete'] = $this->model_extension_d_opencart_patch_url->link('extension/d_blog_module/post/delete', $url);
    ...
    protected function getForm()
    {
        ...
        if (isset($this->request->post['post_description'])) {
            ...
            $data['post_description'] = $this->model_extension_d_blog_module_post->getPostDescription($this->request->get['post_id']);
        } else {
        ...
        if (isset($this->request->post['post_store'])) {
            ...
            $data['post_store'] = $this->model_extension_d_blog_module_post->getPostStores($this->request->get['post_id']);
        } else {
        ...
        if (isset($this->request->get['post_id'])) {
            $categories = $this->model_extension_d_blog_module_post->getPostCategories($this->request->get['post_id']);
        } else {
            $categories = array();
        }
        ...
        if (isset($this->request->get['post_id'])) {
            $data['post_videos'] = $this->model_extension_d_blog_module_post->getPostVideos($this->request->get['post_id']);
        } else {
        ...
        if (isset($this->request->get['post_id'])) {
            $posts = $this->model_extension_d_blog_module_post->getPostRelateds($this->request->get['post_id']);
        } else {
            $posts = array();
        }
        ...
        if (isset($this->request->post['post_layout'])) {
            ...
            $data['post_layout'] = $this->model_extension_d_blog_module_post->getPostLayouts($this->request->get['post_id']);
        } else {
        ...
        //admin_styles
        $this->model_extension_d_admin_style_style->getStyles($this->setting['admin_style']);
