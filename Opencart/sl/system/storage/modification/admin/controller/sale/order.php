...
// Clear Thinking: TaxCloud Integration
				$data['submitted_query'] = $this->db->query("SELECT * FROM " . DB_PREFIX . "order_history WHERE order_id = " . (int)$this->request->get['order_id'] . " AND comment LIKE 'Submitted to TaxCloud%'")->num_rows;
				// end
		$this->load->model('sale/order');
