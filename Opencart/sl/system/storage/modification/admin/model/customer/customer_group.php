...
class ModelCustomerCustomerGroup extends Model {
	public function addCustomerGroup($data) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "customer_group SET approval = '" . (int)$data['approval'] . "',checkout_fixed_fee = '" . (float)$data['checkout_fixed_fee'] . "', checkout_fee_message = '" . $this->db->escape($data['checkout_fee_message']) . "', sort_order = '" . (int)$data['sort_order'] . "'");
	...
	public function editCustomerGroup($customer_group_id, $data) {
		...
		$this->db->query("UPDATE " . DB_PREFIX . "customer_group SET approval = '" . (int)$data['approval'] . "',checkout_fixed_fee = '" . (float)$data['checkout_fixed_fee'] . "', checkout_fee_message = '" . $this->db->escape($data['checkout_fee_message']) . "', sort_order = '" . (int)$data['sort_order'] . "' WHERE customer_group_id = '" . (int)$customer_group_id . "'");
