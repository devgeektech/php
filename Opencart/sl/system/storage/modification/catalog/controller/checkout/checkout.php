...
// Clear Thinking: Ultimate Coupons
				public function checkUltimateCoupon() {
					if (version_compare(VERSION, '2.1', '<')) {
						$this->load->model('checkout/coupon');
						$valid_coupon = $this->model_checkout_coupon->getCoupon($this->request->get['code']);
					} elseif (version_compare(VERSION, '2.3', '<')) {
						$this->load->model('total/coupon');
						$valid_coupon = $this->model_total_coupon->getCoupon($this->request->get['code']);
					} else {
						$this->load->model('extension/total/coupon');
						$valid_coupon = $this->model_extension_total_coupon->getCoupon($this->request->get['code']);
					}
