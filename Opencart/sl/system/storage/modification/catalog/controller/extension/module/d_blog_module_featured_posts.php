...
{
    private $id = 'd_blog_module_featured_posts';
...
//        $this->load->model($this->route);
    ...
    public function index($setting)
    {
        ...
        foreach ($posts as $post) {
            $data['posts'][] = $this->load->controller('extension/d_blog_module/post/thumb', $post);
        }
        ...
        if (empty($data['posts'])) {
            ...
            return $this->load->view('extension/module/d_blog_module_featured_posts', $data);
        }
    }
